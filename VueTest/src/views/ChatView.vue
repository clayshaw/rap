...
<template>
  <div class="space-y-6">
    <div>
      <h1 class="text-xl font-bold tracking-tight">Gemini Chat</h1> <p class="text-muted-foreground">與你的 AI 助理聊天</p>
    </div>

    <Card class="flex flex-col h-[70vh]">
      <CardHeader>
        <CardTitle>聊天室</CardTitle> </CardHeader>

      <CardContent ref="chatContainer" class="flex-1 overflow-y-auto space-y-4 p-4 border-t border-b">
