  ...
  <div class="space-y-6">
    ...
    <Card>
      ...
      <CardContent>
        <div class="space-y-2">
          <div
            class="hidden md:grid grid-cols-5 gap-5 px-5 py-2 text-sm font-medium text-muted-foreground border-b"
          >
          ...
          >
            ...
            <div class="flex justify-between md:block">
              <span class="text-sm md:hidden font-medium text-muted-foreground"
                >Purchase Price</span
              >
    ...
    <div class="grid gap-4 md:grid-cols-2">
        ...
        <CardContent>
          <div class="space-y-4">
            ...
            <div v-else-if="newsList.length > 0" class="space-y-2">
              <div
                v-for="(items, symbol) in groupedNews"
                :key="symbol"
              ...
              >
                ...
                >
                  <div class="flex items-center gap-2">
                    ...
                    <span
                      class="text-xs text-muted-foreground bg-white px-2 py-0.5 rounded-full border"
                    >
                      {{ items.length }}
                    </span>
                  </div>
                  ...
                  <ul class="divide-y">
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          class="text-sm group-hover:text-blue-600 group-hover:underline transition-colors"
                        >
                          {{ news.title }}
                        </span>
                      </a>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div
            v-if="recommendationItems.length === 0 && !isRecommendationsClicked"
            class="text-muted-foreground"
          >
            點擊上方按鈕以載入推薦。
          </div>
          <div
            v-else-if="recommendationItems.length === 0 && isRecommendationsClicked"
            class="text-muted-foreground"
          >
            分析資料載入中
          </div>
